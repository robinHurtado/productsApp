...
import { handleDrop } from '../../../../modules/ActiveBoardData';
...
const List = connect(null, { handleDrop })(ListItem);

export default DropTarget(ItemTypes.CARD, dropSource, collect)(List);