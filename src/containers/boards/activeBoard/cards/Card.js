...
import { archiveCard } from '../../../../modules/ActiveBoardData';
...
const CardCT = connect(mapStateToProps, { archiveCard })(Card);

export default DragSource(ItemTypes.CARD, cardSource, collect)(CardCT);